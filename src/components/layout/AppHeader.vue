...
const navigateTo = (path: string) => {
  // Use router.push with catch to handle dynamic import errors
  router.push(path).catch(err => {
    console.error('Navigation error:', err)
    // If dynamic import fails, try a page reload as fallback
          ...
          <template v-if="authStore.isAuthenticated">
            ...
            <div class="user-dropdown-container">
              ...
              <div v-if="isUserDropdownOpen" class="user-dropdown-menu">
                ...
                <router-link to="/messages" @click="closeUserDropdown" class="dropdown-item">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
